    ...
    return(
         <section id="headerAccount" class="container-fluid">
            <div class="row p-4" id="infoProfile">
                <img src="/assets/images/account/img_account_default.jpg" id="iconProfile" />
                <img src="" alt="" />
            </div>
            <div class="row p-4 mt-5" id="infoHeader">
                <div id="accountName">
                    <p>{user.username}</p>
                    <span id="accountWallet">Wallet Address </span> - <span class="dataLastVisit">Joined June 2022</span>
                </div>
                    ...
                    <div class="dropdown">
                        <button type="button" data-toggle="dropdown" aria-expanded="false">
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                                data-toggle="popover" data-content="Disabled popover" class="bi bi-three-dots"
                                viewBox="0 0 16 16">
                                <path
                        ...
                        <div class="dropdown-menu">
                            <ul>
                                ...
                                <li>WALLET NUMBER <span><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
                                        <path
