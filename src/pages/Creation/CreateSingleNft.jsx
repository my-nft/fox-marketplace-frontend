              ...
              <div>
                ...
                <div className="form-row">
                  <div className="form-group col-md-6">
                    ...
                    <select id="inputState" className="form-control" defaultValue="Level1" name="rightsLevel" required>
                      <option value="Level1" selected>Level1</option>
                    </select>
                  </div>
                  <div className="form-group col-md-6">
                    <label htmlFor="inputState">Rights Duration</label>
                    <select id="inputState" className="form-control" defaultValue="10 Years" name="rightsDurations" required>
