...
import { ReactComponent as Animated } from "../../assets/images/404.svg";
const AnimatedIcon = () => {
  useEffect(() => {
    !(function (t, n) {
        ...
        animations: [
          {
            elements: {
              eShd49fTgqk12: {
                transform: {
                  data: { t: { x: -391.290024, y: -26.802865 } },
                  keys: {
                    o: [
                      {
                        t: 0,
                        v: { x: 391.290024, y: 26.802865, type: "corner" },
                      },
                      {
                        t: 1300,
                        v: { x: 403.405292, y: 33.52925, type: "corner" },
                      },
                      {
                        t: 2600,
                        v: { x: 391.638386, y: 21.753085, type: "corner" },
                      },
                      {
                        t: 4000,
                        v: { x: 391.638362, y: 26.802865, type: "corner" },
                      },
                    ],
                  },
                },
              ...
              eShd49fTgqk13: {
                transform: {
                  data: { t: { x: -341.944044, y: -40.273129 } },
                  keys: {
                    o: [
                      {
                        t: 0,
                        v: { x: 343.214981, y: 42.89208, type: "corner" },
                      },
                      {
                        t: 550,
                        v: { x: 345.619312, y: 45.921977, type: "corner" },
                      },
                      {
                        t: 1200,
                        v: { x: 352.214981, y: 50.89208, type: "corner" },
                      },
                      {
                        t: 2300,
                        v: { x: 349.214981, y: 40.89208, type: "corner" },
                      },
                      {
                        t: 2990,
                        v: { x: 343.114044, y: 38.963135, type: "corner" },
                      },
                      {
                        t: 4000,
                        v: {
                          x: 343.30057944278605,
                          y: 40.937380995024874,
                          a: 84.60246655328375,
                        },
                      },
                    ],
              ...
              eShd49fTgqk16: {
                transform: {
                  data: {
                    o: { x: 363.2, y: 254.407123, type: "corner" },
                    t: { x: -363.199996, y: -254.407121 },
                  },
                  keys: {
                    r: [
                      { t: 1400, v: 0, e: [0.655, 0.215, 0.445, 0.895] },
                      { t: 2400, v: -5.118088, e: [0.645, 0.045, 0.355, 1] },
                      { t: 3200, v: 0 },
                    ],
                  },
                },
              ...
              eShd49fTgqk21: {
                transform: {
                  data: {
                    o: { x: 369.743025, y: 256.373888, type: "corner" },
                    t: { x: -369.743021, y: -256.373888 },
                  },
                  keys: {
                    r: [
                      { t: 1400, v: 0, e: [0.185, 0.32, 0.975, 0.69] },
                      { t: 2400, v: -14.933543, e: [0.62, 0.27, 0.45, 0.94] },
                      { t: 3200, v: 0 },
                    ],
                  },
                },
              ...
              eShd49fTgqk136: {
                transform: {
                  data: {
                    o: { x: 71.833488, y: 152.634995, type: "corner" },
                    t: { x: -71.833482, y: -152.63499 },
                  },
                  keys: {
                    r: [
                      { t: 0, v: -1.716486 },
              ...
              eShd49fTgqk139: {
                transform: {
                  data: {
                    o: { x: 185.799164, y: 165.515836, type: "corner" },
                    t: { x: -185.798219, y: -165.457992 },
                  },
                  keys: {
                    r: [
                      { t: 0, v: 0 },
              ...
              eShd49fTgqk148: {
                transform: {
                  data: { t: { x: -83, y: -118.279999 } },
                  keys: {
                    o: [
                      {
                        t: 0,
                        v: { x: 83, y: 118.279999, type: "corner" },
                        e: [0.505, 1.255, 0.83, 0.51],
                      },
                      {
                        t: 1000,
                        v: { x: 83, y: 130.279999, type: "corner" },
                      ...
                      { t: 4000, v: { x: 83, y: 118.279999, type: "corner" } },
                    ],
                    s: [
                      { t: 0, v: { x: 1, y: 1 }, e: [0.39, 0.575, 0.565, 1] },
                      { t: 900, v: { x: 0, y: 0 }, e: [0.47, 0, 0.745, 0.715] },
                      {
                        t: 1700,
                        v: { x: 0, y: 0 },
            ...
            s: "",
          },
        ],
        options: "MBDAxMDg4MmY4MDgxNmJVEN2Y4MTJmNDcyZjcL5N2M2ZTcxMmZYOGE/H",
      },
      "__SVGATOR_PLAYER__",
      window
    );
