    ...
    return <>
        {
            ...
            <div className="paginationPagesWrapper">
                <p 
                    className={`paginationPage ${currentPage === 1 ? 'paginationPageActive' : null}`}
            ...
            
                {
                    pages && Array.from(Array(pages).keys()).map((item, index) => {
                       ...
                       if(currentPage < 5 ){
                            ...
                            if(index > 0 && index < pages-1 && index >= currentPage - 3 && index <= currentPage + 1){
                                if(pages - index === 1){
                                    return
                                }
                ...
                <p 
                    className={`paginationPage ${currentPage === pages ? 'paginationPageActive' : null}`}
